      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        <div className="flex flex-col items-center mt-10 text-xs text-gray-300">
          ...
          <div className="grid grid-cols-2 gap-11">
            {groupRows.slice(1).map((group, indx) => (
        ...
        <button
          onClick={bookTickets}
          disabled={!selectedTime || !selectedSeats.length}
          className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer hover:scale-95 disabled:opacity-60 disabled:cursor-not-allowed'
        >
          Proceed to Checkout
