...
const MovieDetails = () => {
  ...
  const [show, setShow] = useState(null) // State to hold the movie details
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <img src={image_base_url + show.movie.poster_path} className='max-md:mx-auto rounded-xl h-104 max-w-70 object-cover' alt="" />
